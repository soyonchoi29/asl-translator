...
imgdir = 'C:/Users/soyon/Documents/Codes/ASL-Translator/MediaPipe Processed Kaggle Data'
        ...
        for folder in folders:
            ...
            for image in os.listdir(datadir + '/' + folder):
                ...
                if img is not None:
                    ...
                    img = np.asarray(img).reshape((64, 64, 3))
                    # img = img * (.1/255)
...
if __name__ == "__main__":
    ...
    pickle.dump(data, open("processed_kaggle_X.sav", 'wb'))
    pickle.dump(target, open("processed_kaggle_y.sav", 'wb'))
    ...
    new_cnn_class.save_model("CNN on MediaPipe Processed Kaggle")

    # loaded_model = keras.models.load_model('Fine Tuned ASL CNN')
    # est_loss, train_acc = loaded_model.evaluate(X_train, y_train, verbose=2)
    # print("Estimated training loss: ", est_loss)
    # print("Training accuracy: ", train_acc)
    #
    # est_loss, test_acc = loaded_model.evaluate(X_test, y_test, verbose=2)
    # print("Estimated loss: ", est_loss)
    # print("Testing accuracy: ", test_acc)
